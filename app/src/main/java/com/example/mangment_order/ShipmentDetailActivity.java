                        ...
                        if (snapshot.exists()) {
                            ...
                            for (DataSnapshot child : snapshot.getChildren()) {
                                ...
                                if (shipment != null) {
                                    ...
                                    if("DELIVERED".equalsIgnoreCase(shipment.getStatusOfShipment().name())){
                                    ...
                                    if (finalDateStr != null) {
                                        try {
                                            ...
                                            Date departueDate=sdf.parse(shipment.getDepartureDate());
                                            Date now = new Date();
                                            if(shipment.getStatusOfShipment().ordinal()>4 && shipment.getStatusOfShipment().ordinal()<7){
                                                now.setTime(finalDate.getTime());
                                            }
                                            else if(shipment.getStatusOfShipment().ordinal()<=4 && shipment.getStatusOfShipment().ordinal()>=2){
                                                now.setTime(departueDate.getTime());
                                            }
